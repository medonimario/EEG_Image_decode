...
class Generator4Embeds:
    ...
    def __init__(self, num_inference_steps=1, device='cuda', force_download=False) -> None:
        import os
        ...
        pipe = DiffusionPipeline.from_pretrained("stabilityai/sdxl-turbo", torch_dtype=torch.float16, variant="fp16", force_download=force_download)
